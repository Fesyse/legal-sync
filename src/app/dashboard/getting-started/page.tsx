          ...
          <div className="mx-auto grid max-w-5xl gap-8">
            ...
            <div className="grid gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <p>
                    Вставьте текст вашего ТЗ в специальное поле и нажмите кнопку
                    «Анализировать». Сервис автоматически сформулирует запрос к
                    AI-системе (Gemini) и выполнит поиск по релевантным
                    нормативным актам.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p>
                    ...
                    сопровождается кратким описанием и ссылкой на источник.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="mx-auto max-w-5xl space-y-6">
              ...
              <div className="bg-card rounded-lg p-6 shadow">
                ...
                <p className="mt-4">
                  ...
                  находить именно те НПА, которые относятся к вашему проекту.
                </p>
              </div>
            </div>
          </div>
