  ...
  return (
    <>
      ...
      <form
        ...
        className="bg-foreground/5 absolute bottom-0 left-1/2 min-w-xs -translate-x-1/2 rounded-t-[20px] p-2 min-[479px]:min-w-sm sm:min-w-lg md:min-w-2xl lg:min-w-3xl"
      >
        <Textarea
